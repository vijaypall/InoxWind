<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AudioRecordings.aspx.cs" Inherits="InoxWind.AudioRecordings" %>
            ...
            <div class="w90 margin-center">
                ...
                <div class="page-content mcontainer">
                    <div class="mcontainer common-headings detail-content">
                        <p class="main-title"><span>Audio Recordings</span></p>
                    </div>
                    <div class="pdfs-list certificates-list">
                        <div class="w33 pdf-card">
                            <img src="./assets/images/audio-icon.png" alt="" />
                            <div class="pdf-content">
                                <p>
                                    26th May, 2023 (Recording)
                                </p>
