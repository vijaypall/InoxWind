<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Editor.Master" ClientIDMode="Static" ValidateRequest="false" AutoEventWireup="true" CodeBehind="AddBanner.aspx.cs" Inherits="InoxWind.Admin.AddBanner1" %>
                        ...
                        <form runat="server">
                            ...
                            <div class="row">
                                                <div class="form-group col-sm-3">
                                                    ...
                                                    <asp:DropDownList runat="server" class="form-control" ID="DDlBannerOrder">
                                                ...
                                                <div class="form-group  col-sm-6">
                                                   ...
                                                   <br /> <span>
                                                        <asp:Label Text="" ID="lblerrorUpload" runat="server" ForeColor="Red" />
