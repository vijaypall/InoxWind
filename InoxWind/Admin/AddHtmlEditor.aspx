<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Editor.Master" ValidateRequest="false" AutoEventWireup="true" ClientIDMode="Static" CodeBehind="AddHtmlEditor.aspx.cs" Inherits="InoxWind.Admin.AddHtmlEditor1" %>
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                ...
                <li class="active">Add New Editor</li>
            </ul>
                <!-- /.breadcrumb -->
