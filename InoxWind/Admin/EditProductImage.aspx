<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Editor.Master" AutoEventWireup="true"  ClientIDMode="Static" ValidateRequest="false" CodeBehind="EditProductImage.aspx.cs" Inherits="InoxWind.Admin.EditProductImage" %>
     ...
     <div class="main-content">
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                ...
                <li> 
                    <a href="ProductImage.aspx">Product Image</a>
                </li>
                <li class="active">Edit Product Image</li>
            </ul>
                <!-- /.breadcrumb -->
