<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Editor.Master" AutoEventWireup="true" CodeBehind="EditProductData.aspx.cs" Inherits="InoxWind.Admin.EditProduct" %>
    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                ...
                <li> 
                    <a href="ProductData.aspx">Product Data</a>
                </li>
                <li class="active">Edit Product Data</li>
            </ul>
                <!-- /.breadcrumb -->
                                        ...
                                        <div class="widget-main">
                                            <div class="row" style="padding-left: 0;">
                                                ...
                                                <div class="form-group col-sm-4">
                                                    ...
                                                    <asp:DropDownList runat="server" CssClass="form-control" ID="DdlTecData">
                                                    </asp:DropDownList>
                                                    <span>
                                                        <asp:Label Text="" ID="lblTecDataError" ForeColor="Red" runat="server" /></span>
                                                </div>
                                                <div class="form-group col-sm-4">
                                                    <label>Technical Item*</label>
                                                    <asp:DropDownList runat="server" CssClass="form-control" ID="DdlTechIetm">
                                                    </asp:DropDownList>
                                                    <span>
                                                        <asp:Label Text="" ID="lblTechIetmError" ForeColor="Red" runat="server" /></span>
                                                </div>
                                                <div class="form-group col-sm-4">
                                                    <label>Technical Item value*</label>
                                                    <asp:TextBox runat="server" ID="txttecitemVal" CssClass="form-control" />
                                                    <span>
                                                        <asp:Label Text="" ID="lbltecitemVal" ForeColor="Red" runat="server" /></span>
                                                </div>
                                             <%--   <div class="form-group col-sm-4">
