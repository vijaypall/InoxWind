<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="terms-appointment.aspx.cs" Inherits="InoxWind.terms_appointment" %>
            ...
            <div class="w90 margin-center">
                <nav class="breadcrumbs mcontainer">
                    <ul>
                        ...
                        /
                        <li>
                            <p>Terms & Conditions of Appointment of Independent Directors</p>
                        </li>
                    </ul>
                </nav>
                <div class="page-content mcontainer">
                    <div class="mcontainer common-headings detail-content">
                        <p class="main-title"><span>Appointment Letter</span></p>
                    </div>
